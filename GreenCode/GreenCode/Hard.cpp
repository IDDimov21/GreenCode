...
int hard() {
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        DragNDropCheckAndDamageHard(isinslot1, isinslot2, Option1inCorrectSlot, Option2inCorrectSlot, isSnapped, turncheck, dmgplayer, dmgenemy, original1X, original1Y, original2X, original2Y, original3X, original3Y, original4X, original4Y, player.Health, enemy.EnemyHealth, counter, resetcounter);
        ...
        if (collision) {
            if (!gamestop) {
                ...
                if (resetcounter == 0) {
                    ...
                    DrawTexture(Na, Option3.x, Option3.y, WHITE);
                    DrawTexture(Cl, Option4.x, Option4.y, WHITE);
                    ...
                    DrawText("Connect the elements of: Hydrochloric Acid", 390, 150, 20, BLACK);
                }
                    ...
                    DrawTexture(H, Option3.x, Option3.y, WHITE);
                    DrawTexture(O, Option4.x, Option4.y, WHITE);
                    DrawText("Connect the elements of: Sodium Chloride", 400, 150, 20, BLACK);
                }
